 ...
 */
   ...
   return {
     ...
     payload: {
       ...
       devices: [{
         ...
         name: {
           defaultNames: ['Magic Mirror'],
           name: 'Mirror',
           nicknames: ['mirror', 'display', 'screen'],
         },
         deviceInfo: {
           manufacturer: 'DIY',
           model: 'Raspberry Pi',
         ...
         // required attributes for given traits
         attributes: {
           "volumeMaxLevel": 100,
 ...
 const queryFirebase = async (deviceId) => {
   ...
   return {
     ...
     currentVolume: snapshotVal.Volume.volumeLevel,
 ...
 const updateDevice = async (execution, deviceId) => {
   ...
   switch (command) {
     ...
     case 'action.devices.commands.mute':
       state = {mute: params.mute, isMuted:params.mute};
       ref = firebaseRef.child(deviceId).child('Volume');
       break;
     case 'action.devices.commands.setVolume':
       state = {volumeLevel: params.volumeLevel};
       ref = firebaseRef.child(deviceId).child('Volume');
       break;
     case 'action.devices.commands.volumeRelative':
       state = {relativeSteps: params.relativeSteps};
       ref = firebaseRef.child(deviceId).child('Volume');
       break;
   }
 ...
 exports.reportstate = functions.database.ref('{deviceId}').onWrite(
    ...
    //    functions.logger.info('Firebase write event triggered Report State');
       functions.logger.info("ID: "+context.params.deviceId);
           ...
           devices: {
             states: {
               ...
               [context.params.deviceId]: {
                 ...
                 currentVolume: snapshot.Volume.volumeLevel,
